				...
				if permissions then
					if terminated then
						...
						if onduty then
							...
							TriggerServerEvent("service:takeService")
							setOutfit(outfit)
							return
						end
					end
				else
					exports.core_framework:NoPerms()
					return
				end
			end
		end
